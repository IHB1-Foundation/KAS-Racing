 ...
 *
 * Note: KIP-10 covenant opcodes (0xC1-0xCA) are only active on Testnet 12+
 */
...
export const OP_INPUTSPKHASH = 0xc1;
export const OP_TXINPUTCOUNT = 0xc2;
export const OP_TXOUTPUTCOUNT = 0xc3;
export const OP_OUTPUTVALUE = 0xc4;
export const OP_OUTPUTSPKHASH = 0xc5;
export const OP_UTXOVALUE = 0xc6;
export const OP_UTXOSPKHASH = 0xc7;
export const OP_OUTPOINTTXHASH = 0xc8;
export const OP_OUTPOINTINDEX = 0xc9;
export const OP_INPUTINDEX = 0xca;

/**
 * Check if network supports covenant opcodes
 */
export function supportsCovenants(network: Network): boolean {
